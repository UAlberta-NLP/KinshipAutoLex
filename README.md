# KinshipAutoLex
This repository is for the paper Translation-based Lexicalization Generation and Lexical Gap Detection: Application to Kinship Terms. In *Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, pages 6891–6900, Bangkok, Thailand. Association for Computational Linguistics.

[[Paper](https://aclanthology.org/2024.acl-long.372/)] [[Poster](https://github.com/UAlberta-NLP/KinshipAutoLex/blob/main/assets/poster.pdf)] [[Slides](https://github.com/UAlberta-NLP/KinshipAutoLex/blob/main/assets/slides.pdf)]
